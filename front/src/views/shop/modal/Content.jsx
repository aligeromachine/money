...
export const ShopContent = ({ visible, onClose, formData, onChange, validate, repErr, onAdd }) => {
    return (
        <CModal size="lg" visible={visible} onClose={onClose}>
            ...
            <CModalBody>
                <CForm className="row g-3">
                    ...
                    <CCol xs={12}>
                        <CFormInput label="Title" placeholder="Magazine" onChange={onChange} value={formData.title || ''} name={'title'} />
