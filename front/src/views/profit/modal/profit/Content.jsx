        ...
        <CModal size="lg" visible={visible} onClose={onClose}>
            ...
            <CModalBody>
                <CForm className="row g-3">
                    ...
                    <CCol xs={12}>
                        <CFormInput label="Title" placeholder="April" onChange={onChange} value={formData.title || ''} name={'title'} />
                        <RedLable title={validate.title} />
                    </CCol>
                    <CCol xs={12}>
                        <CFormInput label="Amount" placeholder="235456.2" onChange={onChange} value={formData.amount || ''} name={'amount'} />
